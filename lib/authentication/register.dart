...
import 'package:vendor_application/widgets/custom_text_fields.dart';
import 'package:vendor_application/widgets/error_dialog.dart';
import 'package:vendor_application/widgets/loading_dialog.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
      ...
      if (passwordController.text == confirmPasswordController.text) {
        if (confirmPasswordController.text.isNotEmpty &&
          ...
          showDialog(
              ...
              builder: (c) {
                return LoadingDialog(
                  message: "Registration InProgress",
                );
              });
          ...
          fStorage.UploadTask uploadTask = reference.putFile(
            ...
            fStorage.SettableMetadata(contentType: "image/jpeg"),
          );
          ...
          showDialog(
              ...
              builder: (c) {
                return ErrorDialog(
                  message:
                      "Input fields missing data, please enter complete information.",
                );
              });
        }
      } else {
  ...
  Future saveDataToFirestore(User currentUser) async {
    FirebaseFirestore.instance.collection("vendors").doc(currentUser.uid).set({
      ...
      "sellerAvatarUrl": vendorImageURL,
